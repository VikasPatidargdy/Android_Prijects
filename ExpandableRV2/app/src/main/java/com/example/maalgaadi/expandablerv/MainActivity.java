...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final List<MovieCategory> movieCategories = new ArrayList<>();
        movieCategories.addAll(Arrays.asList(molvie_category_one, molvie_category_two, molvie_category_three, molvie_category_four));
        ...
        ItemTouchHelper.SimpleCallback simpleCallback = new ItemTouchHelper.SimpleCallback(0, ItemTouchHelper.LEFT) {
            ...
            public void onSwiped(RecyclerView.ViewHolder viewHolder, int direction) {
                ...
                movieCategories.remove(viewHolder.getAdapterPosition());
