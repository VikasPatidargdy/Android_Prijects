package com.example.maalgaadi.switchanimation;
...
import com.example.maalgaadi.switchanimation.R;
import com.example.maalgaadi.switchanimation.page.PageFragment;
...
public class MainActivity extends FragmentActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        viewPager = (CardViewPager) findViewById(R.id.card_view_pager);

        pagerAdapter = new CardPagerAdapter<Card>(getSupportFragmentManager(), PageFragment.class,R.layout.page_layout,items,this);
